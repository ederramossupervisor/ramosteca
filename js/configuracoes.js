  ...
  function restaurarDadosLocaisDoBackup(dadosLocais) {
    try {
      ...
      if (dadosLocais.leitorConfig) {
        localStorage.setItem('ramosteca_leitor_config', JSON.stringify(dadosLocais.leitorConfig));
      }
    } catch (e) {
